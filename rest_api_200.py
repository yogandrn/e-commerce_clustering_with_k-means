...
def clustering(params) :
    ...
    # data = [
    #     {"sold" : 12, "rating_score" : 4.8, "count_review" : 6},
    #     {"sold" : 22, "rating_score" : 4.9, "count_review" : 14},
    #     {"sold" : 108, "rating_score" : 4.9, "count_review" : 60},
    ...
    # sorted_data = generateCentroids(random_data)
    print(sorted_data[0]["sold"], sorted_data[1]["sold"], sorted_data[2]["sold"])
